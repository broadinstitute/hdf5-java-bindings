...
public final class HDF5Library {
     ...
     * provided by {@link H5}.
     *
     * @throws HDF5LibException if the library cannot be instantiated.
     */
    private HDF5Library() {
        final int code;
        try {
            ...
            throw new HDF5LibException("could not instantiate the HDF5 Library, due to an exception.",e);
        ...
        if (code < 0) {
            throw new HDF5LibException("could not instantiate the HDF5 library. H5open returned a negative value: " + code);
        }
    }
     ...
     * </p>
     *
     * @throws HDF5LibException if HDF5 is not supported.
     */
